...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    expect(getCharacter('Melissandre').phrases).toEqual[('IDeath By Fire Is The Purest Death.', 'For The Night Is Dark And Full Of Terrors.')];
    ...
    expect(getCharacter('Aline')).toBe(undefined)
